...
import g = ThisCouldBeBetter.Geometry;

// Geometry.
import Coords = g.Coords;
...
// Geometry - Shapes.
import Arc = g.Arc;
import BoxAxisAligned = g.BoxAxisAligned;
import BoxOriented = g.BoxOriented;
import Cylinder = g.Cylinder;
import Edge = g.Edge;
import Face = g.Face;
import Hemispace = g.Hemispace;
import Path = g.Path;
import PathBuilder = g.PathBuilder;
import Plane = g.Plane;
import Point = g.Point;
import Ray = g.Ray;
import Shape = g.Shape;
import ShapeBase = g.ShapeBase;
import ShapeContainer = g.ShapeContainer;
import ShapeGroupAll = g.ShapeGroupAll;
import ShapeGroupAny = g.ShapeGroupAny;
import ShapeInverse = g.ShapeInverse;
import ShapeNone = g.ShapeNone;
import ShapeTransformed = g.ShapeTransformed;
import ShapeWrapped = g.ShapeWrapped;
import Shell = g.Shell;
import Sphere = g.Sphere;
import Wedge = g.Wedge;
